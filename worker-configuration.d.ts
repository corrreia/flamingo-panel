/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a161c2bc7dcaeb3db9f68ca29fce53f)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ConsoleSession";
	}
	interface Env {
		KV: KVNamespace;
		R2: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PANEL_URL">> {}
}
