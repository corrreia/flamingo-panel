/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3fea95a85e653bffbda5821970d54631)
// Runtime types generated with workerd@1.20260219.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/web/server");
		durableNamespaces: "ConsoleSession" | "NodeMetrics";
	}
	interface Env {
		KV: KVNamespace;
		R2: R2Bucket;
		DB: D1Database;
		PANEL_URL: "https://urw-marks-growing-bacterial.trycloudflare.com";
		OIDC_DISCOVERY_URL: "https://auth.tomascorreia.net/.well-known/openid-configuration";
		BETTER_AUTH_SECRET: string;
		OIDC_CLIENT_ID: string;
		OIDC_CLIENT_SECRET: string;
		CONSOLE_SESSION: DurableObjectNamespace<import("./src/web/server").ConsoleSession>;
		NODE_METRICS: DurableObjectNamespace<import("./src/web/server").NodeMetrics>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PANEL_URL" | "OIDC_DISCOVERY_URL" | "BETTER_AUTH_SECRET" | "OIDC_CLIENT_ID" | "OIDC_CLIENT_SECRET">> {}
}
